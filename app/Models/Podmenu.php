...
class Podmenu extends Model
{
    ...
    */
    ...
    protected $table = 'podmenu';
    // protected $primaryKey = 'id';
    // public $timestamps = false;
    // protected $guarded = ['id'];
      protected $fillable = ['name', 'stat', 'id_pod'];
      protected $hidden = [ 'stat', 'id_pod'];
    // protected $dates = [];


    public function menu()
    {
        return $this->belongsTo('App\Models\Menu', 'id_pod', 'id');
    }
